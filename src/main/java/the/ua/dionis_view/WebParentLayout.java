...
public class WebParentLayout extends FrameLayout implements the.ua.dionis_view.Provider<the.ua.dionis_view.AbsAgentWebUIController> {
	private the.ua.dionis_view.AbsAgentWebUIController mAgentWebUIController = null;
	private static final String TAG = the.ua.dionis_view.WebParentLayout.class.getSimpleName();
	@LayoutRes
	...
	void bindController(the.ua.dionis_view.AbsAgentWebUIController agentWebUIController) {
	...
	@Override
	public the.ua.dionis_view.AbsAgentWebUIController provide() {

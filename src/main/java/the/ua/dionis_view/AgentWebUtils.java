...
import static the.ua.dionis_view.AgentWebConfig.AGENTWEB_FILE_PATH;
import static the.ua.dionis_view.AgentWebConfig.FILE_CACHE_PATH;


public class AgentWebUtils {

	private static final String TAG = the.ua.dionis_view.AgentWebUtils.class.getSimpleName();

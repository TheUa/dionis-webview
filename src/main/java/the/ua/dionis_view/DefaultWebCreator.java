...
import static the.ua.dionis_view.AgentWebConfig.WEBVIEW_DEFAULT_TYPE;
...
public class DefaultWebCreator implements WebCreator {
    ...
    private static final String TAG = the.ua.dionis_view.DefaultWebCreator.class.getSimpleName();
    ...
    @Override
    public the.ua.dionis_view.DefaultWebCreator create() {
        if (mIsCreated) {
            return this;
        }
        mIsCreated = true;

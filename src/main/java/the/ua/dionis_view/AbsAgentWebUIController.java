...
public abstract class AbsAgentWebUIController {
	...
	protected the.ua.dionis_view.AbsAgentWebUIController mAgentWebUIControllerDelegate;
	...
	protected the.ua.dionis_view.AbsAgentWebUIController create() {
		return HAS_DESIGN_LIB ? new the.ua.dionis_view.DefaultDesignUIController() : new the.ua.dionis_view.DefaultUIController();
	}

	protected the.ua.dionis_view.AbsAgentWebUIController getDelegate() {
		the.ua.dionis_view.AbsAgentWebUIController mAgentWebUIController = this.mAgentWebUIControllerDelegate;

...
public class WebIndicator extends the.ua.dionis_view.BaseIndicatorView implements the.ua.dionis_view.BaseIndicatorSpec {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mWebIndicatorDefaultHeight = the.ua.dionis_view.AgentWebUtils.dp2px(context, 3);
    }
    ...
    private ValueAnimator.AnimatorUpdateListener mAnimatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            the.ua.dionis_view.WebIndicator.this.mCurrentProgress = t;
            the.ua.dionis_view.WebIndicator.this.invalidate();
        }
    };

...
public class AgentWebView extends LollipopFixedWebView {
    private static final String TAG = the.ua.dionis_view.AgentWebView.class.getSimpleName();
     ...
     * 3、webChromeClient.onProgressChanged JS，（onJsPrompt）JS，url；
     *
     */
    @Override
    @Deprecated
    ...
    public static class AgentWebClient extends MiddlewareWebClientBase {
        ...
        private the.ua.dionis_view.AgentWebView mAgentWebView;

        private AgentWebClient(the.ua.dionis_view.AgentWebView agentWebView) {
    ...
    public static class AgentWebChrome extends MiddlewareWebChromeBase {
        ...
        private AgentWebChrome(the.ua.dionis_view.AgentWebView agentWebView) {
            this.mAgentWebView = agentWebView;
        }

...
public final class DionisView {
    public static final int OPEN_WINDOW_IN_DIALOG = 0;
    /**
     * AgentWeb 's TAG
     */
    private static final String TAG = the.ua.dionis_view.DionisView.class.getSimpleName();
    /**
     * Activity
     */
    private Activity mActivity;
    /**
     *  WebParentLayout  ViewGroup
     */
    private ViewGroup mViewGroup;
    /**
     * WebView ，WebParentLayout  Indicator。
     */
     ...
     * AgentWeb
     */
    private the.ua.dionis_view.DionisView mDionisView = null;
    /**
     ...
     * WebChromeClient
     */
    private the.ua.dionis_view.WebChromeClient mWebChromeClient;
    /**
     * WebViewClient
     */
    private the.ua.dionis_view.WebViewClient mWebViewClient;
    /**
     * is show indicator
     */
    ...
    /**
     * URL Loader ，  WebView#loadUrl(url) reload() stopLoading（） postUrl()
     */
    ...
    /**
     * MiddlewareWebChromeBase WebChromeClient
     */
    ...
    private DionisView(AgentBuilder agentBuilder) {
        ...
        mWebSecurityController = new WebSecurityControllerImpl(mWebCreator.getWebView(), this.mDionisView.mJavaObjects, this.mSecurityType);
    ...
    public the.ua.dionis_view.DionisView clearWebCache() {
    ...
    public static class PreAgentWeb {
        ...
        PreAgentWeb(the.ua.dionis_view.DionisView dionisView) {
        ...
        public the.ua.dionis_view.DionisView get() {
            ready();
            return mDionisView;
        }

        public the.ua.dionis_view.DionisView go(@Nullable String url) {
            if (!isReady) {
                ready();
            }
            return mDionisView.go(url);
        }
    }
    ...
    private WebCreator configWebCreator(BaseIndicatorView progressView, int index, ViewGroup.LayoutParams lp, int indicatorColor, int height_dp, WebView webView, IWebLayout webLayout) {
        if (progressView != null && mEnableIndicator) {
            return new the.ua.dionis_view.DefaultWebCreator(mActivity, mViewGroup, lp, index, progressView, webView, webLayout);
        } else {
            return mEnableIndicator ?
                    new the.ua.dionis_view.DefaultWebCreator(mActivity, mViewGroup, lp, index, indicatorColor, height_dp, webView, webLayout)
                    : new the.ua.dionis_view.DefaultWebCreator(mActivity, mViewGroup, lp, index, webView, webLayout);
        }
    }

    private the.ua.dionis_view.DionisView go(String url) {
    ...
    private the.ua.dionis_view.DionisView ready() {
    ...
    public static final class AgentBuilder {
        public int mWebViewClientWindowKey;
        private Activity mActivity;
        ...
        public AgentBuilder(@NonNull Activity activity, @NonNull Fragment fragment) {
            mActivity = activity;
            mFragment = fragment;
            mTag = the.ua.dionis_view.DionisView.FRAGMENT_TAG;
        }

        public AgentBuilder(@NonNull Activity activity) {
            mActivity = activity;
            mTag = the.ua.dionis_view.DionisView.ACTIVITY_TAG;
        }
        ...
        private PreAgentWeb buildAgentWeb() {
            if (mTag == the.ua.dionis_view.DionisView.FRAGMENT_TAG && this.mViewGroup == null) {
                throw new NullPointerException("ViewGroup is null,Please check your parameters .");
            }
            return new PreAgentWeb(HookManager.hookAgentWeb(new the.ua.dionis_view.DionisView(this), this));
        }
    ...
    public static class CommonBuilder {
        ...
        public CommonBuilder setWebChromeClient(@Nullable the.ua.dionis_view.WebChromeClient webChromeClient) {
            this.mAgentBuilder.mWebChromeClient = webChromeClient;
            return this;
        }

        public CommonBuilder setWebViewClient(@Nullable the.ua.dionis_view.WebViewClient webChromeClient) {
...
//        public CommonBuilder setWebViewClient(the.ua.dionis_view.WebViewClient webViewClient) {
//            this.mAgentBuilder.mWebViewClient = webViewClient;
//            this.mAgentBuilder.mWebViewClientWindowKey = openWindowInDialog;
//            return this;
//        }

//        public CommonBuilder setWebViewOpenWindow(int keyWindow) {
//            this.mAgentBuilder =
//            return this;
//        }
    }

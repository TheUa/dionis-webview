...
public class VideoImpl implements IVideo, the.ua.dionis_view.EventInterceptor {

    private Activity mActivity;
    private WebView mWebView;
    private static final String TAG = the.ua.dionis_view.VideoImpl.class.getSimpleName();

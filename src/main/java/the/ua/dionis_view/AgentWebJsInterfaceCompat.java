...
public class AgentWebJsInterfaceCompat {
	...
	private WeakReference<the.ua.dionis_view.DionisView> mReference = null;
	private WeakReference<Activity> mActivityWeakReference = null;
	private String TAG = this.getClass().getSimpleName();

	AgentWebJsInterfaceCompat(the.ua.dionis_view.DionisView dionisView, Activity activity) {
		mReference = new WeakReference<the.ua.dionis_view.DionisView>(dionisView);
	...
	public void uploadFile(String acceptType) {
		...
		if (mActivityWeakReference.get() != null && mReference.get() != null) {
			the.ua.dionis_view.AgentWebUtils.showFileChooserCompat(mActivityWeakReference.get(),
